...
namespace mercharteria.Data.Migrations
{
    ...
    [Migration("20250523183856_UpdatePersonajeImageProperties")]
    partial class UpdatePersonajeImageProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mercharteria.Models.Contacto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mercharteria.Models.DatosCliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("t_DatosCliente");
                });

            modelBuilder.Entity("mercharteria.Models.DetalleOrden", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mercharteria.Models.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mercharteria.Models.ProductoPersonaje", b =>
                {
                    b.Property<int>("ProductoId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ProductoId", "PersonajeId");

                    b.HasIndex("PersonajeId");

                    b.ToTable("ProductoPersonajes");
                });
            ...
            modelBuilder.Entity("mercharteria.Models.DetalleOrden", b =>
                {
                    b.HasOne("mercharteria.Models.Orden", "Orden")
                        .WithMany("Detalles")
                        .HasForeignKey("OrdenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mercharteria.Models.Producto", "Producto")
                        .WithMany()
            ...
            modelBuilder.Entity("mercharteria.Models.Orden", b =>
                {
                    b.HasOne("mercharteria.Models.DatosCliente", "DatosCliente")
                        .WithMany()
            ...
            modelBuilder.Entity("mercharteria.Models.ProductoPersonaje", b =>
                {
                    b.HasOne("mercharteria.Models.Personaje", "Personaje")
                        .WithMany()
