...
namespace mercharteria.ML      
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\ABRAHAM\Downloads\mercharteria\mercharteria\ML\trainingdata\comentarios_sentimiento_500_corregido.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Comentario",outputColumnName:@"Comentario")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Comentario"}))      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=989,NumberOfIterations=791,MinimumExampleCountPerLeaf=23,LearningRate=0.4457760267155563,LabelColumnName=@"Label",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9916981499984738,L1Regularization=2E-10,L2Regularization=0.9999997766729865},MaximumBinCountPerFeature=254}))      
